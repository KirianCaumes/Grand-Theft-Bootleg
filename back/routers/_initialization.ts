...
import { userUpdateValidator } from "../validators/userUpdate.validator.ts"
...
const userController = new UserController(usersCollection, userValidator, userPasswordValidator, userUpdateValidator, mailService)
